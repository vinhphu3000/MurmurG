...
Thank you for purchasing Noise Generators! This asset supports Mac, Windows, iOS, and Android. To use the plugins in your project, follow the platform-specific configuration steps:
...
LFO Frequency: Controls the frequency (0.01 - 20.0 Hz) of the sinusoidal oscillator that modulates the noise amplitude.
LFO Depth: Controls the intensity of the modulation (0.0 - 100.0).

—————

If you have questions or feedback about Noise Generators, please contact the developer at administrator@anor.ac
